...
public class L {
	...
	public static void ogCmdInit(Command c) {
		System.out.println("- INIT ------- " + c.hashCode() + " - " + c.getName());
	}
	
	public static void ogCmdInit(Command c, String s) {
		System.out.println("- INIT ------- " + c.hashCode() + " - " + c.getName() + ", s");
	}
	
	public static void ogCmdEnd(Command c) {
		System.out.println("-- END ------- " + c.hashCode() + " - " + c.getName());
	}

	public static void ogCmdInterrupted(Command c) {
		System.out.println("-- INTERRUPT - " + c.hashCode() + " - " + c.getName());
	}
